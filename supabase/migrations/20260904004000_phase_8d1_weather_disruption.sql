-- Phase 8D1 extends the existing deterministic schedule shift with the
-- weather-delay option. Keep the original Phase 8B migration immutable.
...
begin
  if p_day_number is null or p_day_number < 1
    or p_minutes not in (15, 30, 60, 90)
